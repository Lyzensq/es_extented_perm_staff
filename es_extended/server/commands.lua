...
-----------------------------------------------------------------------------------------------------------------------
--------------------------------------##PERMS___________DEV##---------FULL_PERM-------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------

ESX.RegisterCommand('setcoords', '_dev', function(xPlayer, args, showError)
...
ESX.RegisterCommand('setjob', '_dev', function(xPlayer, args, showError)
...
ESX.RegisterCommand('setjob2', '_dev', function(xPlayer, args, showError)
...
ESX.RegisterCommand('car', '_dev', function(xPlayer, args, showError)
...
ESX.RegisterCommand({'cardel', 'dv'}, '_dev', function(xPlayer, args, showError)
...
ESX.RegisterCommand('setaccountmoney', '_dev', function(xPlayer, args, showError)
...
ESX.RegisterCommand('giveaccountmoney', '_dev', function(xPlayer, args, showError)
	if args.playerId.getAccount(args.account) then
...
ESX.RegisterCommand('giveitem', '_dev', function(xPlayer, args, showError)
...
ESX.RegisterCommand('giveweapon', '_dev', function(xPlayer, args, showError)
...
ESX.RegisterCommand('giveweaponcomponent', '_dev', function(xPlayer, args, showError)
...
ESX.RegisterCommand({'clearall', 'clsall'}, '_dev', function(xPlayer, args, showError)
	TriggerClientEvent('chat:clear', -1)
end, false, {help = _U('command_clearall')})

ESX.RegisterCommand('clearinventory', '_dev', function(xPlayer, args, showError)
...
ESX.RegisterCommand('clearloadout', '_dev', function(xPlayer, args, showError)
...
ESX.RegisterCommand('setgroup', '_dev', function(xPlayer, args, showError)
	if not args.playerId then args.playerId = xPlayer.source end
	if args.group == "superadmin" then args.group = "_dev" end
...
ESX.RegisterCommand('save', '_dev', function(xPlayer, args, showError)
	ESX.SavePlayer(args.playerId)
end, true, {help = _U('command_save'), validate = true, arguments = {
	{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand('saveall', '_dev', function(xPlayer, args, showError)
	ESX.SavePlayers()
end, true, {help = _U('command_saveall')})

ESX.RegisterCommand('group', {"user", "_dev"}, function(xPlayer, args, showError)
	print(xPlayer.getName()..", You are currently: ^5".. xPlayer.getGroup())
end, true)

ESX.RegisterCommand('job', {"user", "_dev"}, function(xPlayer, args, showError)
	print(xPlayer.getName()..", You are currently: ^5".. xPlayer.getJob().name.. "^0 - ^5".. xPlayer.getJob().grade_label)
end, true)

ESX.RegisterCommand('job2', {"user", "_dev"}, function(xPlayer, args, showError)
	print(xPlayer.getName()..", You are currently: ^5".. xPlayer.getJob2().name.. "^0 - ^5".. xPlayer.getJob2().grade_label)
end, true)
	
ESX.RegisterCommand('info', {"user", "_dev"}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('coords', "_dev", function(xPlayer, args, showError)
	print("".. xPlayer.getName().. ": ^5".. xPlayer.getCoords(true))
end, true)

ESX.RegisterCommand('tpm', "_dev", function(xPlayer, args, showError)
	xPlayer.triggerEvent("esx:tpm")
end, true)

ESX.RegisterCommand('goto', "_dev", function(xPlayer, args, showError)
...
ESX.RegisterCommand('bring', "_dev", function(xPlayer, args, showError)
...
ESX.RegisterCommand('kill', "_dev", function(xPlayer, args, showError)
	args.playerId.triggerEvent('esx:killPlayer')
end, true, {help = _U('kill'), validate = true, arguments = {
{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand('freeze', "_dev", function(xPlayer, args, showError)
	args.playerId.triggerEvent('esx:freezePlayer', "freeze")
end, true, {help = _U('kill'), validate = true, arguments = {
{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand('unfreeze', "_dev", function(xPlayer, args, showError)
	args.playerId.triggerEvent('esx:freezePlayer', "unfreeze")
end, true, {help = _U('kill'), validate = true, arguments = {
{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand('reviveall', "_dev", function(xPlayer, args, showError)
	for _, playerId in ipairs(GetPlayers()) do
		TriggerClientEvent('esx_ambulancejob:revive', playerId)
	end
end, false)

ESX.RegisterCommand("noclip", '_dev', function(xPlayer, args, showError)
	xPlayer.triggerEvent('esx:noclip')
end, false)

ESX.RegisterCommand('players', "_dev", function(xPlayer, args, showError)
...
ESX.RegisterCommand('unfreeze', "mod", function(xPlayer, args, showError)
	args.playerId.triggerEvent('esx:freezePlayer', "unfreeze")
end, true, {help = _U('kill'), validate = true, arguments = {
{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
}})
...
ESX.RegisterCommand('coords', "mod", function(xPlayer, args, showError)
	print("".. xPlayer.getName().. ": ^5".. xPlayer.getCoords(true))
end, true)
...
ESX.RegisterCommand('players', "mod", function(xPlayer, args, showError)
	local xAll = ESX.GetPlayers()
	print("^5"..#xAll.." ^2online player(s)^0")
	for i=1, #xAll, 1 do
		local xPlayer = ESX.GetPlayerFromId(xAll[i])
